...
public class SecurityFilter implements Filter {
    ...
    private static final String CONTEXT_ROOT = "/adminNetwork";
    ...
    public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain) throws IOException, ServletException {
        ...
        if (isLogin && requestServletPath.equals("/index.xhtml")) {
            ...
            httpServletResponse.sendRedirect(CONTEXT_ROOT + "/checkNric.xhtml");
        }

        if (!excludeLoginCheck(requestServletPath)) {
            if (isLogin) {
                if (httpSession.getAttribute("voter") == null) {
                    if(requestServletPath.startsWith("/checkNric.xhtml")){
